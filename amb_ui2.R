                     ...
                     fluidRow(
                       boxPlus(
                         ...
                         tabBox(
                           ...
                           tabPanel("Total", 
                                    "Placeholder for avg/median new patient visit ratio by day"),
                           tabPanel("By Provider",
                                    "Placeholder for avg/median new patient visit ratio by day and provider")))),
                     fluidRow(
                       boxPlus(
                         ...
                         tabBox(
                           ...
                           tabPanel("Total", 
                                    "Placeholder for avg/median new patient wait time by day"),
                           tabPanel("By Provider",
                                    "Placeholder for avg/median new patient wait time by day and provider")))),
                     fluidRow(
                       boxPlus(
                     ...
                     fluidRow(
                       boxPlus(
                         ...
                         tabBox(
                           ...
                           id = "tabset4", width = "100%",
                           tabPanel("Total", 
                                    "Placeholder for booked rate (%) by day"),
                           tabPanel("By Provider",
